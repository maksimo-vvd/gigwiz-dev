...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        'c-dark': {
          DEFAULT: 'var(--clr-dark)',
          hover: 'var(--bg-btn-dark-hover)',
          disabled: 'var(--bg-btn-dark-disabled)',
        },
        'c-pink': {
          DEFAULT: 'var(--clr-pink)',
          hover: 'var(--bg-btn-pink-hover)',
          disabled: 'var(--bg-btn-pink-disabled)',
        },
        'c-gray': {
          light: 'var(--clr-gray-light)',
          DEFAULT: 'var(--clr-gray)',
          dark: 'var(--clr-gray-dark)',
        },
        'c-green': {
          light: 'var(--clr-green-light)',
          DEFAULT: 'var(--clr-green)',
          dark: 'var(--clr-green-dark)',
          hover: 'var(--bg-btn-green-hover)',
          disabled: 'var(--bg-btn-green-disabled)',
          'tag': "var(--bg-tag-green)",
          'tag-hover': 'var(--bg-tag-green-hover)',
          'tag-disabled': 'var(--bg-tag-green-disabled)',
        }
      },
      fontFamily: {
